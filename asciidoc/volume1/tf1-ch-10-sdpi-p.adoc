...
NOTE: TLS 1.2 is not sufficient for all types of connectivity (e.g., cloud, remote programming, etc.), and it has reported cypher-suite weaknesses. TLS 1.3 may be hence required depending on the risk associated with the device.
