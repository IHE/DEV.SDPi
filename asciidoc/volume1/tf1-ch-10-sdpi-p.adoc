...
[#vol1_clause_sdpi_p_option_managed_discovery,role=profile-option,profile-option-id="sdpi-p-managed-discovery",oid-arcs=".1,.1.1"]
...
[role=profile-option,profile-option-id="sdpi-p-gateway-direction-export",oid-arcs=".2,.2.1"]
...
[role=profile-option,profile-option-id="sdpi-p-gateway-direction-import",oid-arcs=".3,.3.1"]
