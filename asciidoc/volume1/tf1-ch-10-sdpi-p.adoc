...
Note 5: This transaction must be supported if <<vol1_spec_sdpi_p_option_gateway_direction>> (Direction="export") is enabled.

Note 6: This transaction must be supported if <<vol1_spec_sdpi_p_option_gateway_direction>> (Direction="import") is enabled.
