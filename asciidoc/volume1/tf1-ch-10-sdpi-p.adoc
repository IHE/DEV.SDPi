...
To claim conformity with this profile, an actor shall support all required transactions (labeled “R”) and may support the optional transactions (labeled “O”).
...
A product implementation using this profile may group afrom this profile with actors from a workflow or transport profile to be functional.
