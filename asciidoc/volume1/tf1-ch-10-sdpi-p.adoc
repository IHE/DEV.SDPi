...
A product implementation using this specification may group Actors from this specification with Actors from a workflow or transport profile to be functional.
The grouping of the content module described in this specification to specific Actors is described in more detail in <<vol1_clause_sdpi_p_required_actor_groupings>> or in <<vol1_clause_sdpi_p_cross_profile_considerations>>.
