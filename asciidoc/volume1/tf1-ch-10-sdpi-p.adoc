...
.20+| <<vol1_spec_sdpi_p_actor_somds_fhir_gateway>>
.^| <<transaction_name_announce_network_presence>>
.^| Initiator
.^| R  ^(See^ ^Note^ ^6)^
| <<vol2_clause_dev_23>>
...
Note 5: This transaction must be supported if <<vol1_spec_sdpi_p_option_sdc_gateway_direction>> (Direction="export") is enabled.

Note 6: This transaction must be supported if <<vol1_spec_sdpi_p_option_sdc_gateway_direction>> (Direction="import") is enabled.
...
| <<vol1_spec_sdpi_p_actor_somds_v2_gateway>>
| <<vol1_spec_sdpi_p_option_sdc_gateway_direction>>
| <<vol1_clause_sdpi_p_option_sdc_gateway_direction>>
...
| <<vol1_spec_sdpi_p_actor_somds_consumer>>
| <<vol1_spec_sdpi_p_option_sdc_real_time_waveforms>>
| <<vol1_clause_sdpi_p_option_sdc_real_time_waveforms>>
...
When the <<vol1_spec_sdpi_p_option_managed_discovery>> is enabled for a <<vol1_spec_sdpi_p_actor_somds_provider>> Actor, then it shall use the <<vol2_clause_dev_46, DEV-46>> transaction to update the <<vol1_spec_sdpi_p_actor_discovery_proxy>> Actor on its network presence and departure.
****
...
When the <<vol1_spec_sdpi_p_option_managed_discovery>> is enabled for a <<vol1_spec_sdpi_p_actor_somds_consumer>> Actor, then it shall use the <<vol2_clause_dev_47, DEV-47>> transaction to retrieve <<vol1_spec_sdpi_p_actor_somds_provider>> network presence metadata from the  <<vol1_spec_sdpi_p_actor_discovery_proxy>> Actor.
...
[#vol1_clause_sdpi_p_option_sdc_gateway_direction]
==== SDC Gateway Direction Option
[#vol1_spec_sdpi_p_option_sdc_gateway_direction, reftext='SDC Gateway Direction Option']

The SDC Gateway Direction option specifies the flow of information through the gateway actor.
...
[#vol1_table_sdpi_p_sdc_discovery_direction_options]
.SDC Gateway Discovery Direction Option Values
[%autowidth]
[cols="1,1,1"]
|===
.^|Direction
...
[#vol1_clause_sdpi_p_option_sdc_real_time_waveforms]
==== SDC Real Time Waveforms Option
[#vol1_spec_sdpi_p_option_sdc_real_time_waveforms, reftext='SDC Real Time Waveforms Option']
...
[#vol1_table_sdpi_p_option_sdc_real_time_waveform_required_transactions]
...
An actor from this profile (Column 1) shall implement all required transactions for the grouped actor (Column 3) in <<vol1_table_sdpi_p_required_actor_groupings>>.
...
| <<vol1_spec_sdpi_p_actor_somds_fhir_gateway>>
| <<vol1_spec_sdpi_p_option_sdc_gateway_direction>> (Direction="export")
| <<vol1_spec_sdpi_p_actor_somds_consumer>>
| <<vol1_clause_sdpi_p_option_sdc_gateway_direction>>

| <<vol1_spec_sdpi_p_actor_somds_fhir_gateway>>
| <<vol1_spec_sdpi_p_option_sdc_gateway_direction>> (Direction="import")
| <<vol1_spec_sdpi_p_actor_somds_provider>>
| <<vol1_clause_sdpi_p_option_sdc_gateway_direction>>
