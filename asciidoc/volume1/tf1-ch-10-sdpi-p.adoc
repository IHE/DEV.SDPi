...
If one of the Gateway Direction options is not configured, then the DEFAULT 
direction of any gateway actors shall be "export". 

.R1030
[sdpi_requirement#r1030,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
...
[role=profile-option,profile-option-id="sdpi-p-gateway-direction-export"]
...
.R1031
[sdpi_requirement#r1031,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
...
[role=profile-option,profile-option-id="sdpi-p-gateway-direction-import"]
...
.R1032
[sdpi_requirement#r1032,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
