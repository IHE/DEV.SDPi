...
[#vol1_clause_sdpi_p_profile,sdpi_offset=10,role=profile,profile-id=sdpi-p,reftext="Plug-and-trust Profile"]
== Service-oriented Device Point-of-care Interoperability – Plug-and-trust (SDPi-P) Profile
...
sdpi_include_transaction::DEV-46[initiator="optional", receiver="required"]
...
sdpi_include_transaction::DEV-32[actor-id="somds_provider",responder="optional",placeholder-name="Retrieve archive data"]
sdpi_include_transaction::DEV-33[actor-id="somds_provider",responder="optional",placeholder-name="Retrieve localization information"]
...
sdpi_include_transaction::DEV-32[actor-id="somds_consumer",initiator="optional",placeholder-name="Retrieve archive data"]
sdpi_include_transaction::DEV-33[actor-id="somds_consumer",initiator="optional",placeholder-name="Retrieve localization information"]
...
[NOTE]
====
* _“Notify Change in System Context and Capabilities”_ is required if there are 
...
<<vol1_clause_sdpi_p_somds_connector>>, <<vol1_clause_sdpi_p_somds_fhir_gateway>>, 
<<vol1_clause_sdpi_p_somds_v2_gateway>>, <<vol1_clause_sdpi_p_somds_sensor_gateway>>, 
<<vol1_clause_sdpi_p_somds_smart_app_platform>>, <<vol1_clause_sdpi_p_biceps_content_creator>>, and
<<vol1_clause_sdpi_p_biceps_content_consumer>> actors. 
====

ifndef::not-defined[]

[#vol1_table_sdpi_p_actors_transactions2]
.SDPi-P Profile - Actors and Transactions
[%autowidth]
[cols="1,2,1,1,3"]
|===
...
[#vol1_clause_sdpi_p_somds_participant,role="actor actor-alias",actor-id="somds_participant"]
===== SOMDS Participant
...
[#vol1_clause_sdpi_p_somds_provider,role="actor actor-alias",actor-id="somds_provider"]
===== SOMDS Provider
...
[#vol1_clause_sdpi_p_somds_consumer,role="actor actor-alias",actor-id="somds_consumer"]
===== SOMDS Consumer
...
[#vol1_clause_sdpi_p_somds_connector,role="actor actor-alias",actor-id="somds_connector"]
===== SOMDS Connector
...
[#vol1_clause_sdpi_p_somds_fhir_gateway,role="actor actor-alias",actor-id="somds_fhir_gateway"]
===== SOMDS FHIR Gateway
...
[#vol1_clause_sdpi_p_somds_v2_gateway,role="actor actor-alias",actor-id="somds_v2_gateway"]
===== SOMDS V2 Gateway
...
[#vol1_clause_sdpi_p_somds_sensor_gateway,role="actor actor-alias",actor-id="somds_sensor_gateway"]]
...
[#vol1_clause_sdpi_p_somds_smart_app_platform,role="actor actor-alias",actor-id="somds_smart_app"]
...
[#vol1_clause_sdpi_p_biceps_content_creator,role="actor actor-alias",actor-id="biceps_content_creator"]
...
[#vol1_clause_sdpi_p_biceps_content_consumer,role="actor actor-alias",actor-id="biceps_content_consumer"]
...
[#vol1_clause_sdpi_p_discovery_proxy,role="actor actor-alias",actor-id="discovery_proxy"]
===== Discovery Proxy
...
[#vol1_clause_sdpi_p_option_discovery_proxy,role=profile-option,profile-option-id="sdpi-p-managed-discovery"]
...
sdpi_include_use_case::stad[actor-id="somds_participant", support=required]
sdpi_include_use_case::stad[actor-id="somds_provider", support=required]
sdpi_include_use_case::stad[actor-id="somds_consumer", support=required]
sdpi_include_use_case::stad[actor-id="somds_connector", support=required]
sdpi_include_use_case::stad[actor-id="somds_fhir_gateway", support=required]
sdpi_include_use_case::stad[actor-id="somds_v2_gateway", support=required]
sdpi_include_use_case::stad[actor-id="somds_sensor_gateway", support=required]
sdpi_include_use_case::stad[actor-id="somds_smart_app", support=required]
sdpi_include_use_case::stad[actor-id="biceps_content_creator", support=required]
sdpi_include_use_case::stad[actor-id="biceps_content_consumer", support=required]
sdpi_include_use_case::stad[actor-id="discovery_proxy", support=required]
...
sdpi_include_use_case::sicdsp[actor-id="somds_consumer", support=optional]
sdpi_include_use_case::sicdsp[actor-id="somds_connector", support=optional]
sdpi_include_use_case::sicdsp[actor-id="somds_smart_app", support=optional]
sdpi_include_use_case::sicdsp[actor-id="biceps_content_consumer", support=optional]
...
sdpi_include_use_case::sicdmp[actor-id="somds_consumer", support=optional]
sdpi_include_use_case::sicdmp[actor-id="somds_connector", support=optional]
sdpi_include_use_case::sicdmp[actor-id="somds_smart_app", support=optional]
sdpi_include_use_case::sicdmp[actor-id="biceps_content_consumer", support=optional]
...
sdpi_include_use_case::ddes[actor-id="somds_connector", support=required]
sdpi_include_use_case::ddes[actor-id="somds_fhir_gateway", support=required]
sdpi_include_use_case::ddes[actor-id="somds_v2_gateway", support=required]
sdpi_include_use_case::ddes[actor-id="somds_sensor_gateway", support=required]
...
sdpi_include_use_case::acns[actor-id="somds_connector", support=optional]
sdpi_include_use_case::acns[actor-id="somds_fhir_gateway", support=optional]
sdpi_include_use_case::acns[actor-id="somds_v2_gateway", support=optional]
sdpi_include_use_case::acns[actor-id="somds_sensor_gateway", support=optional]
...
sdpi_include_use_case::aars[actor-id="somds_connector", support=optional]
sdpi_include_use_case::aars[actor-id="somds_fhir_gateway", support=optional]
sdpi_include_use_case::aars[actor-id="somds_v2_gateway", support=optional]
sdpi_include_use_case::aars[actor-id="somds_sensor_gateway", support=optional]
...
For the default <<acronym_sdpi_p>> connectivity technology, namely ISO/IEEE 11073 <<term_service_oriented_device_connectivity>>, TLS 1.2 (or higher versions) support is required (See <<ref_ieee_11073_20701_2018>> and <<ref_ieee_11073_20702_2016>>).
