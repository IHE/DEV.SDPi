...
[#vol1_spec_sdpi_p_actor_somds_discovery_proxy, reftext='Discovery Proxy']
Actor Summary Definition:
[none]
...
<<figure_sdpi-p-discovery-proxy-option-sequence-diagram>> provides an overview of the interactions of the SOMDS Consumer and Somes Provider Actors with the Discovery Proxy Actor.
