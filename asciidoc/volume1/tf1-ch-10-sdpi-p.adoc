...
[#vol1_clause_sdpi_p_somds_provider,role="actor actor-alias",actor-id="somds_provider",oid-arcs=.41]
===== SOMDS Provider
...
[#vol1_clause_sdpi_p_somds_consumer,role="actor actor-alias",actor-id="somds_consumer",oid-arcs=.30]
===== SOMDS Consumer
...
[#vol1_clause_sdpi_p_somds_connector,role="actor actor-alias",actor-id="somds_connector",oid-arcs=.29]
===== SOMDS Connector
...
| <<vol1_spec_sdpi_p_option_gateway_direction>>
| <<vol1_clause_sdpi_p_option_gateway_direction>>
...
[#vol1_clause_sdpi_p_option_managed_discovery,role=profile-option,profile-option-id="sdpi-p-managed-discovery"]
...
[#vol1_clause_sdpi_p_option_gateway_direction]
==== Gateway Direction Option
[#vol1_spec_sdpi_p_option_gateway_direction, reftext='Gateway Direction Option']

The Gateway Direction option specifies the flow of information through the gateway actor.
If this option is not configured, then the DEFAULT direction of any gateway actors shall be "export".
Each gateway actor, which is an instance of the abstract <<vol1_spec_sdpi_p_actor_somds_connector>> Actor, shall be grouped with either a <<vol1_spec_sdpi_p_actor_somds_provider>> Actor, <<vol1_spec_sdpi_p_actor_somds_consumer>> Actor, or both.

The following table details the options that shall be selected:

[#vol1_table_sdpi_p_gateway_direction_options]
.Gateway Direction Option Values
[%autowidth]
[cols="1,1,1"]
|===
.^|Direction
...
| Gateway retrieves information from SOMDS Provider systems, converts and sends it to other systems.

| import
| <<vol1_spec_sdpi_p_actor_somds_provider>>
| Gateway retrieves information from external systems, and provides the content to SOMDS Consumer systems.

| bidirectional
| <<vol1_spec_sdpi_p_actor_somds_consumer>> + <<vol1_spec_sdpi_p_actor_somds_provider>>
...
| <<vol1_spec_sdpi_p_option_gateway_direction>> (Direction="export")
| <<vol1_spec_sdpi_p_actor_somds_consumer>>
| <<vol1_clause_sdpi_p_option_gateway_direction>>

| <<vol1_spec_sdpi_p_option_gateway_direction>> (Direction="import")
| <<vol1_spec_sdpi_p_actor_somds_provider>>
| <<vol1_clause_sdpi_p_option_gateway_direction>>

| <<vol1_spec_sdpi_p_option_gateway_direction>> (Direction="bidirectional")
