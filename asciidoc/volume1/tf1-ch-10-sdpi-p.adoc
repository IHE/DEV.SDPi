...
Options that may be selected for this Integration Profile are listed in the #*_<table reference>_*# along with the actors to which they apply.
Dependencies between options when applicable are specified in
notes.

#*<insert "SDPi-P Actors and Options" table>*#
