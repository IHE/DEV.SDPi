...
[cols="1"]
|===
a| *SDPi Supplement Version Note*:  _*For SDPi 1.1*_, no use cases have been included that provide functional requirements for device external control.  These will be added to a future version of the SDPi supplement.
