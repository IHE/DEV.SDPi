...
[#vol1_clause_sdpi_xc_somds_medical_control_provider,role="actor actor-alias",actor-id="somds_medical_control_provider"]
...
[#vol1_clause_sdpi_xc_somds_medical_control_consumer,role="actor actor-alias",actor-id="somds_medical_control_consumer"]
