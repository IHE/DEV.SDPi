...
****
If a <<vol1_spec_sdpi_p_actor_somds_provider>> cannot reach the <<acronym_ts_service>> and can no longer guarantee a 50ms accuracy, it shall provide ClockState/@Accuracy.
