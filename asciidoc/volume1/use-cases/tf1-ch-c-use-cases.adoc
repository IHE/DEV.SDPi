...
[cols="1"]
|===
a| *{standard_note}*: This appendix of profile-non-specific use cases is novel to this SDPi standard and is not present in other IHE technical framework specifications.
It is integral to the normative "requirements interoperability" aspect of this standard, though, and must be given a clear placement to ensure that this is maintained.

#REVIEWER QUESTIONS#:

. Should these detailed use case specifications be retained in this Volume 1 appendix or located in a separate SDPi Use Cases clause (top level)?
If so, where in the standard would this be located?
Before Volume 1 or after Volume 3?
. IF maintained an a separate Volume 1 appendix, should a summary of use cases be added to the Front Matter (e.g., SDPi Standard Overview)?
. *_A broader question is if NORMATIVE CONTENT is allowed outside of the Volume 1-3 structure of the standard?_*
