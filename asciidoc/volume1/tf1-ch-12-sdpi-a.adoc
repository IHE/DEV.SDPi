...
For additional general guidance, see Section <<clause_ses_considerations_and_requirements>>.
...
No additional security requirements and considerations are identified for this technical framework element beyond those provided by the  SDPi-P Profile (see <<clause_ses_considerations_section_template>>), and those specified in the _<<acronym_ses>> General Considerations_ Section above.
