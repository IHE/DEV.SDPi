...
[#vol1_clause_sdpi_a_somds_medical_alert_provider,role="actor actor-alias",actor-id="somds_medical_alert_provider"]
...
[#vol1_clause_sdpi_a_somds_medical_alert_consumer,role="actor actor-alias",actor-id="somds_medical_alert_consumer"]
...
[#vol1_clause_sdpi_a_somds_acm_gateway,role="actor actor-alias",actor-id="somds_acm_gateway"]
===== SOMDS ACM Gateway
