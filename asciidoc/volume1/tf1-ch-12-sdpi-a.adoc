...
This default configuration requires the grouped <<vol1_spec_sdpi_p_actor_somds_v2_gateway>> Actor <<vol1_spec_sdpi_p_option_gateway_direction>> (Direction="export") option is enabled.
