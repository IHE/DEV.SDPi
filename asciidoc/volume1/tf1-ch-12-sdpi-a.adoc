...
When this new standard is published, its requirements will be integrated into this standard, with its <<term_implementation_conformance_statement>> added to <<vol1_appendix_b_referenced_standards_conformance>>.
