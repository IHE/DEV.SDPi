...
[#vol1_clause_sdpi_a_actor_option_alert_delegation,role=actor-option,actor-option-id=alert_delegation]
...
[#vol1_clause_sdpi_a_actor_option_alert_user_acknowledgement,role=actor-option,actor-option-id=alert_user_acknowledgement]
...
[#vol1_clause_sdpi_a_actor_option_remote_alert_signaling,role=actor-option,actor-option-id=remote_alert_signaling]
