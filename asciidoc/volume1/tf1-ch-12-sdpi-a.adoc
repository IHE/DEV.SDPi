...
Note:  Not supported are <<vol1_spec_sdpi_a_actor_somds_dec_gateway>> systems that only implement the <<vol1_spec_sdpi_a_actor_somds_medical_alert_provider>> and not <<vol1_spec_sdpi_a_actor_somds_medical_alert_consumer>> capabilities.
