...
[NOTE]
====
* By default, the <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> acts as a <<vol1_spec_sdpi_a_actor_somds_medical_alert_consumer>>, initiating [DEV-04] transactions when they are received from <<vol1_spec_sdpi_a_actor_somds_medical_alert_consumer>>s.
...
* See <<vol1_clause_sdpi_a_required_actor_groupings>> for actor inheritance and grouping.
====
