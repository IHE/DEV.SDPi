...
This default configuration requires the grouped <<vol1_spec_sdpi_p_actor_somds_v2_gateway>> Actor to have the <<vol1_spec_sdpi_p_option_gateway_export>> enabled.
...
Note 3: Transaction is required if <<vol1_clause_sdpi_a_actor_option_distributed_alarm_system>> is supported.
|===