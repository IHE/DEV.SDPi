...
** The root OID for all requirements in the IHE DEV profile is `1.3.6.1.4.1.19376.1.6.10`.
** The numeric part of the Unique Identifier is the final arc for the OID, for example: `1.3.6.1.4.1.19376.1.6.10.1234`. 
...
* New requirement identifiers (_unique identifier_ and _requirement oid) are assigned following material changes to a requirements normative statement and the old identifier is retired, never to be used again.
* Assignment may evolve with experience and extended use. 

Material modifications include those that may:
...
Material changes do not include:
