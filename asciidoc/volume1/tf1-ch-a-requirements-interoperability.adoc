...
.R7666
[sdpi_requirement#r7666,sdpi_req_level=shall,sdpi_req_profile=sdpi-p,sdpi_req_actor=discovery_proxy]
****
Reference to a requirement in another AsciiDoc file:  <<r8007>>

sdpi_requirement#r7666,

sdpi_req_level=shall,

sdpi_req_profile=sdpi-p,

sdpi_req_actor=discovery_proxy
