...
Gateway directionality (export, import, or bidirectional) is specified by the <<vol1_spec_sdpi_p_option_gateway_direction>> in the <<vol1_clause_sdpi_p_profile_reftext>>.
