...
[cols="1"]
|===
a| *{supplement_note}*:  The <<ref_ieee_11073_10700_2022>> and <<ref_ieee_11073_10701_2022>> standards are now published by the IEEE.
However, their requirements are yet to be integrated into this supplement, with many of them being mapped to elements in this <<acronym_sdpi_r>> Profile.
