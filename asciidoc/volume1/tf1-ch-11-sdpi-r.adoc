...
[#vol1_clause_sdpi_r_somds_medical_data_provider,role="actor actor-alias",actor-id="somds_medical_data_provider"]
...
[#vol1_clause_sdpi_r_somds_medical_data_consumer,role="actor actor-alias",actor-id="somds_medical_data_consumer"]
...
[#vol1_clause_sdpi_r_somds_dec_gateway, reftext='SOMDS DEC Gateway',role="actor actor-alias",actor-id="somds_dec_gateway"]
===== SOMDS DEC Gateway
...
[#vol1_spec_sdpi_r_actor_somds_fhir_medical_data_gateway, reftext='SOMDS FHIR Medical Data Gateway',role="actor actor-alias",actor-id="somds_fhir_medical_data_gateway"]
Actor Summary Definition:
[none]
