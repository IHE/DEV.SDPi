...
Key considerations include safety, security and effectiveness for data reporting, alert notification, device-external control and other high-acuity (e.g., ICU, OR, Step-Down, Emergency response) use cases.
Provision is made for coordination of individual device functional contributions to support Clinical System Functions.


#EdNote:  Original component points ...
[none]
. _Safe, effective and secure medical device interoperability_
...
. ecosystem (vendor independent) of ... products ...
