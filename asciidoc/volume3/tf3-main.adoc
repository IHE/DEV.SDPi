...
[cols="1"]
|===
a| *{standard_note}*: The organization of this Volume 3 standard factors in two major changes:
...
[cols="1"]
|===
a| *{standard_note}*: This is a place holder section for content modules related to the Personal Health Device (PHD) semantics defined in the IEEE 11073-10206 and 11073-20601 standards.
