...
. IHE Supplement template (2020), with content mapped from the <<ref_ihe_pcd_tf_3_2024>> specification;
...
For the existing TF-3 content in the <<ref_ihe_pcd_tf_3_2024>>, especially Section 3, though this supplement includes editor guidance for which sections are mapped where in the updated outline, the actual content is a mix of general device informatics topics and details that are based on the "classic" <<ref_ieee_11073_10201_2004>> DIM.
...
[cols="1"]
|===
| Move IHE PCD 2019 TF-3 Section 3 (text immediately after the section header) to this SDPi {ihe_supplement_sdpi_revision_short} TF-3 Section 8.1
|===
...
[cols="1"]
|===
| Move IHE PCD 2019 TF-3 sections 3.1 to this SDPi {ihe_supplement_sdpi_revision_short} TF-3 Section 8.2
|===
...
[cols="1"]
|===
a| *{supplement_note}*: The content in the IHE PCD 2019 TF-3 3.1 Section will need to be edited to be agnostic to the underlying protocol, with protocol specifics being relegated to subsections in <<vol3_clause_protocol_specific_content_module_considerations>> below.
|===
...
[cols="1"]
|===
| Move IHE PCD 2019 TF-3 Section 5 Reserved to this SDPi {ihe_supplement_sdpi_revision_short} TF-3 Section 8.5
|===
...
[cols="1"]
|===
| Move IHE PCD 2019 TF-3 Section 6 Reserved to this {ihe_supplement_sdpi_revision_short} TF-3 Section 8.6
|===
