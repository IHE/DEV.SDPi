...
Additionally, for this version of SDPi 1.1, it isn't clear how best to address a similar division of the device specialization sections (e.g., infusion pump or ventilator).
...
[cols="1"]
|===
| Move IHE PCD 2019 TF-3 Section 3 (text immediately after the section header) to this SDPi 1.1 TF-3 Section 8.1
|===
...
[cols="1"]
|===
| Move IHE PCD 2019 TF-3 sections 3.1 to this SDPi 1.1 TF-3 Section 8.2
|===
...
[cols="1"]
|===
| Move IHE PCD 2019 TF-3 sections 3.2 to 3.7 to this SDPi 1.1 TF-3 Section 8.3.1.2 TO 8.3.1..7
...
[cols="1"]
|===
| Move IHE PCD 2019 TF-3 Section 5 Reserved to this SDPi 1.1 TF-3 Section 8.5
|===
...
[cols="1"]
|===
| Move IHE PCD 2019 TF-3 Section 6 Reserved to this SDPi 1.1 TF-3 Section 8.6
|===
