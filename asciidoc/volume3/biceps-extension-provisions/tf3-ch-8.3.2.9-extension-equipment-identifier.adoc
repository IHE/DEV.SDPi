...
****
For the `sdpi:EquipmentIdentifier` extension, a <<actor_somds_provider>> shall use a stable and globally unique URI that is constant across re-initializations of the <<actor_somds_provider>>.
****
