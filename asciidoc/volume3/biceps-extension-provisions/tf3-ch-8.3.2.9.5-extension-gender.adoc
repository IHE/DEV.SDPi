...
[cols="1"]
|===
a| *{standard_note}*: As mentioned in the main text below, <<acronym_biceps>> does not currently provide sex and gender semantic support at the same level of detail as foundational existing and emerging standards.
...
.R0012
[sdpi_requirement#r0012,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
