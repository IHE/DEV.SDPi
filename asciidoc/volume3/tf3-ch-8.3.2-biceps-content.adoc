...
[cols="1"]
|===
a| *{supplement_note}*:  The <<acronym_sdc>> standards community is evaluating the use of safety class elements in the BICEPS specification (see <<ref_ieee_11073_10207_2017_Cor1_2025>>), and the related https://github.com/IHE/DEV.SDPi/issues/11[Github Issue #11 _Topic: SDPi-xC with Mixed Device Safety Classes_].
...
* <<ref_ieee_11073_10207_2017_Cor1_2025>> Clause 8, especially R0109, and
