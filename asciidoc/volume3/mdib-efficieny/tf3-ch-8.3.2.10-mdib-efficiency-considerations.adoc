...
Even though compression und decompression of data requires devices to consume additional CPU cycles, the transmission of data in the <<acronym_md_lan>> is more expensive especially when using wireless technology.
