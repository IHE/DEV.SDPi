...
. Comment on the value, or not, of moving all conformance-related content to this clause, and whether any additional sections should be added earlier in the document regarding identification (listing) of those normative references that will be included in this clause.
