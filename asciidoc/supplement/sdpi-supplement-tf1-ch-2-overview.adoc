...
It is *_not part of the capabilities specified for SDPi {ihe_supplement_sdpi_revision_short}_* and even basic controls will not be added until SDPi 3.0 or later.
|===
