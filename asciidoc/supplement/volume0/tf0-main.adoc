...
|This specification, used by the <<actor_somds_discovery_proxy>> actor.

|dpws
|http://docs.oasis-open.org/ws-dd/ns/dpws/2009/01
| #LINK OR TEXT#:ref_oasis_dpws_2009
...
| #LINK OR TEXT#:ref_oasis_ws_addressing_2006

|wsd
|http://docs.oasis-open.org/ws-dd/ns/discovery/2009/01
| #LINK OR TEXT#:ref_oasis_ws_discovery_2009

|wse
|http://schemas.xmlsoap.org/ws/2004/08/eventing
| #LINK OR TEXT#:ref_w3c_ws_eventing_2006

|wsm
|http://schemas.xmlsoap.org/ws/2004/09/mex
| #LINK OR TEXT#:ref_w3c_ws_metadata_exchange_2008
