...
|Enables seamless interaction with systems and software applications that are outside the scope of the SOMDS network.
...
|Exchanges medical data with an IHE DEC-based environment
...
|Provides basic common connectivity capabilities for all actors that are part of a SOMDS network.
