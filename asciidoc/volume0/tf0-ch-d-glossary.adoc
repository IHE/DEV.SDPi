...
| Structured collection of any data objects that are provided by a <<vol1_spec_sdpi_p_actor_somds_provider>> or <<vol1_spec_sdpi_p_actor_biceps_content_creator>>, including both descriptive and state information.
|
