...
[NORMATIVE]
====
A filter in the Dialect designated `urn:oid:1.3.6.1.4.1.19376.1.6.2.10.1.3.1.1` shall contain exactly, and only, one hm:QueryFilter of type hm:QueryFilterType.
====
