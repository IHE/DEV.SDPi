...
.R0507
[sdpi_requirement#r0507,sdpi_req_level=shall,subs=normal]
****
...
****
A <<vol1_spec_sdpi_p_actor_somds_provider>> shall signify the end of the historic MDIB data stream by sending a hm:ChangeSequenceReport notification that contains 0 pm:ChangeSequence elements.
****
