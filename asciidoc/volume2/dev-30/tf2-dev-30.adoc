...
[role=transaction,transaction-id=DEV-30]
...
(As the communication is encrypted, this can include ContextStates without violating <<ref_ieee_11073_10207_2017_Cor1_2025>> R0121.)
