...
This section specifies the MDPWS data transmission for messages defined in <<vol2_clause_dev_23>>, corresponding to the WS-Discovery ad-hoc mode.
...
.R2000
[sdpi_requirement#r2000,sdpi_req_level=should,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
