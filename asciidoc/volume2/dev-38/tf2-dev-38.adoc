...
[role=transaction,transaction-id=DEV-38]
...
Initiates communication by first subscribing to a RefActor:somds_consumer[] by sending a {var_label_dev_38_message_subscribe} message.
