...
In order to produce valid messages, the implementation of a <<vol1_spec_sdpi_p_actor_somds_participant>> needs to conform to the
...
include::duration/tf2-ch-a-mdpws-duration.adoc[]