...
* <<ref_oasis_ws_eventing_2006>> {var_uri_ws_eventing_subscribe}[Section 3.1 Subscribe]
...
[%collapsible]
====
NOTE: The WS-Eventing specification that is normatively included in <<ref_oasis_dpws_2009>> explains the absence of _Expires_ in a SubscribeResponse message (see <<ref_oasis_ws_eventing_2006>>, Section 3.1), which is actually prohibited according to the XML Schema. This profile underlines the need to provide an _Expires_ element in SubscribeResponse messages.
====
****
...
* <<ref_oasis_ws_eventing_2006>> {var_uri_ws_eventing_notification}[Section 4 Notifications]
* <<ref_oasis_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
* <<ref_oasis_ws_eventing_2006>> {var_uri_ws_eventing_renew}[Section 3.2 Renew]
* <<ref_oasis_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
[%collapsible]
====
NOTE: The WS-Eventing specification that is normatively included in <<ref_oasis_dpws_2009>> does not explain the absence of _Expires_ in a RenewResponse message (see <<ref_oasis_ws_eventing_2006>>, Section 3.2). This profile prohibits the absence of _Expires_ in RenewResponse messages to avoid subscriptions that run infinitely.
====
****
...
* <<ref_oasis_ws_eventing_2006>> {var_uri_ws_eventing_unsubscribe}[Section 3.4 Unsubscribe]
* <<ref_oasis_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
* <<ref_oasis_ws_eventing_2006>> {var_uri_ws_eventing_unsubscribe_response}[Section 3.4 Unsubscribe]
* <<ref_oasis_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
* <<ref_oasis_ws_eventing_2006>> {var_uri_ws_eventing_subscription_end}[Section 3.5 Subscription End]
* <<ref_oasis_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
