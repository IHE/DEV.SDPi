...
`s12:Envelope/s12:Body/wse:Subscribe/wse:Expires`:: <<payload_dev_27_susbcribe_expiration_time>> as an {var_uri_xsd_duration}[XML Schema duration], constrained to hours, minutes and seconds according to <<r1018>>.
...
`s12:Envelope/s12:Body/wse:SubscribeResponse/wse:Expires`:: <<payload_dev_27_subscribe_response_expiration_time>> as an {var_uri_xsd_duration}[XML Schema duration], constrained to hours, minutes and seconds according to <<r1018>>.
...
.R7003
[sdpi_requirement#r7003,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
...
.R7004
[sdpi_requirement#r7004,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
...
* <<ref_w3c_ws_eventing_2006>> {var_uri_ws_eventing_notification}[Section 4 Notifications]
* <<ref_oasis_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
* <<ref_w3c_ws_eventing_2006>> {var_uri_ws_eventing_renew}[Section 3.2 Renew]
* <<ref_oasis_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
`s12:Envelope/s12:Body/wse:Renew/wse:Expires`:: <<payload_dev_27_renew_expiration_time>> as an {var_uri_xsd_duration}[XML Schema duration], constrained to hours, minutes and seconds according to <<r1018>>.
...
`s12:Envelope/s12:Body/wse:RenewResponse/wse:Expires`:: <<payload_dev_27_renew_response_expiration_time>> as an {var_uri_xsd_duration}[XML Schema duration], constrained to hours, minutes and seconds according to <<r1018>>.
...
.R7005
[sdpi_requirement#r7005,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
...
* <<ref_w3c_ws_eventing_2006>> {var_uri_ws_eventing_unsubscribe}[Section 3.4 Unsubscribe]
* <<ref_oasis_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
* <<ref_w3c_ws_eventing_2006>> {var_uri_ws_eventing_unsubscribe_response}[Section 3.4 Unsubscribe]
* <<ref_oasis_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
* <<ref_w3c_ws_eventing_2006>> {var_uri_ws_eventing_subscription_end}[Section 3.5 Subscription End]
* <<ref_oasis_dpws_2009>> {var_uri_dpws_eventing}[Section 5 Eventing]
...
`s12:Envelope/s12:Body/wse:SubscriptionEnd/wse:SubscriptionManager/wsa:Address`:: URI of the <<payload_dev_27_subscribe_response_subscription_manager>> that manages the subscription that ended.
