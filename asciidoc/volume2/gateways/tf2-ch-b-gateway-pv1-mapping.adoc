...
.R8111
[sdpi_requirement#r8111,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
...
====== PV1-2 Patient Class
.R8112
[sdpi_requirement#r8112,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> / <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the PV1-2 field to the code for the patient class.
====
...
.R8113
[sdpi_requirement#r8113,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
If <<r8111>> is met, then a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> / <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the PV1-3 field to the patient's assigned location.
====
...
====== PV1-19 Visit Number
.R8114
[sdpi_requirement#r8114,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
If <<r8111>> is met, then a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> / <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the PV1-19 field to the patient's visit identifier.
...
.R8115
[sdpi_requirement#r8115,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
If <<r8111>> is met, then a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> / <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the PV1-44 field to the patient's admission date/time.
====
...
This said, it is up to the <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> / <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> to figure out the admission date/time to be set in the PV1-44 field. If the gateway is not able to determine the admission date/time, the field is left empty.
====
****

====== PV1-51 Visit Indicator
.R8116
[sdpi_requirement#r8116,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
If <<r8111>> is met, then a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> / <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the PV1-51 field to the code for the visit indicator.
