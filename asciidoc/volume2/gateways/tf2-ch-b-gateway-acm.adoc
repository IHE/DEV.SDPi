...
The <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> represents the Alarm Reporter (AR) role of the IHE ACM profile.
...
.R8050
[sdpi_requirement#r8050,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
For the IHE ACM profile, the <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the OBR-2 field to the identifier of the Alarm Reporter (AR) of the IHE ACM gateway (not the individual device identifier).
====
...
.R8051
[sdpi_requirement#r8051,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the OBR-3 field to a unique identifier for the status to the alert indication.
====
...
.R8052
[sdpi_requirement#r8052,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
For the *initial alert event announcement message*, a <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the OBR-3/EI-1 field to the unique identifier for the alert event.
====
...
.R8053
[sdpi_requirement#r8053,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
For the *subsequent alert event messages for the same alert event*, a <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the OBR-3/EI-1 field to the unique identifier of the alert event message that relates to the same alert event as announced in the initial alert event message.
====
...
.R8054
[sdpi_requirement#r8054,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the OBR-4 field to *"196616\^MDC_EVT_ALARM^MDC"*.
====
****

====== OBR-7 Observation Date/Time
.R8055
[sdpi_requirement#r8055,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the OBR-7 field to the date and time at which the Alert Reporter (AR) of the IHE ACM gateway created the alert event message to be sent.
====
...
====== OBR-29 Parent
.R8056
[sdpi_requirement#r8056,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the OBR-29 field to the unique alert event identifier of the initial alert event message as defined for the OBR-3 field.
====
...
.R8057
[sdpi_requirement#r8057,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall export device-related OBX segments, which define the hierarchical relationship of the alert event in the device's containment tree.
====
...
.R8058
[sdpi_requirement#r8058,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
...
.R8061
[sdpi_requirement#r8061,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****

[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall export an Event Identification OBX segment which identifies the alert event.
====
...
.R8077
[sdpi_requirement#r8077,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****

[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall report the Alert Event Phase as "update" when there are more updates than just the Alert Priority as specified in <<ref_tbl_acm_obx14_alert_phase_mapping>>  for the "update" Alert Event Phase.
====
...
====== Date/Time Mapping
.R8062
[sdpi_requirement#r8062,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the OBX-14 field of the Event Identification OBX segment to the date/time of the alert event status change.
====
...
.R8063
[sdpi_requirement#r8063,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
...
.R8064
[sdpi_requirement#r8064,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
If a private *<<acronym_mdc>>* code is used for the coding of the SDC coded element value, the identifier shall be mapped as described in Section <<ref_private_coding_system_note>>.
...
.R8065
[sdpi_requirement#r8065,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall export a Source Identification OBX segment, which identifies the source that led to the alert event.
====
...
.R8059
[sdpi_requirement#r8059,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
For a physiological alert event, a <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the OBX-3 field in the <<ref_acm_obx_source_id_mapping>> to the source identifier.
====
****

.R8060
[sdpi_requirement#r8060,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
For a technical or advisory alert event, a <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the OBX-5 field in the <<ref_acm_obx_source_id_mapping>> to the source identifier.
====
****
...
====== Physiological Alerts
.R8066
[sdpi_requirement#r8066,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall map the source identification for physiological alerts (alarms or advisories) to an OBX segment as defined in <<ref_dec_obx_mapping>>. The gateway captures the state of the related metric at the time the alert event occurred.
====
...
.R8067
[sdpi_requirement#r8067,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the OBX-4 Observation Sub-ID to *"<MDS>.<VMD>.<CHAN>.<METRIC>.2"* where *<MDS>*, *<VMD>*, *<CHAN>*, and *<METRIC>* are the numbers of the device’s containment tree levels assigned by the gateway.
====
****

.R8068
[sdpi_requirement#r8068,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall set the OBX-11 Observation Result Status to *"R"*.
====
****
...
.R8069
[sdpi_requirement#r8069,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
If a private *<<acronym_mdc>>* code is used for the coding of the SDC coded element value, the identifier shall be mapped as described in Section <<ref_private_coding_system_note>>.
...
.R8070
[sdpi_requirement#r8070,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall export an Event Phase OBX segment, which identifies the alert event phase.
====
...
.R8078
[sdpi_requirement#r8078,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****

[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall report the Alert Event Phase as "update" when there are more updates than just the Alert Priority as specified in <<ref_tbl_alert_phase_mapping>> for the "update" Alert Event Phase.
====
...
.R8071
[sdpi_requirement#r8071,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall export an Alert State OBX segment, which defines the current state of the alert event.
====
...
.R8072
[sdpi_requirement#r8072,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall only report an inactive alert condition when the alarm condition transitioned from active or latched to inactive.
====
****
...
.R8073
[sdpi_requirement#r8073,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall export an Inactivation State OBX segment, which defines the current inactivation state of the alert event.
====
...
.R8074
[sdpi_requirement#r8074,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall map the SDC *pm:AlertConditionDescriptor/@Priority* attribute to an IHE ACM Alert Priority OBX segment as defined in the <<ref_ihe_dev_tf_2_2024>>.
====
...
.R8075
[sdpi_requirement#r8075,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
...
.R8076
[sdpi_requirement#r8076,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_a_actor_somds_acm_gateway>> shall map the SDC *pm:AlertConditionDescriptor/@Kind* to an IHE ACM Alert Type OBX segment as defined in the <<ref_ihe_dev_tf_2_2024>>.
====
...
.R8079
[sdpi_requirement#r8079,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
