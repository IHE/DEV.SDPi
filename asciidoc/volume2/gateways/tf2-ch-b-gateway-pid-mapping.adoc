...
/@Code
|Note that if *pm:Race/@Code* contains a private code, the corresponding translation is to be mapped. In this case, only the first entry of the *pm:Translation* element list is to be mapped.
