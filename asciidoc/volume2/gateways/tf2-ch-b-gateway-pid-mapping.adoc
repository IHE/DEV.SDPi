...
NOTE: If the SDC patient context information is not intended to be used for the mapping, please refer to the <<ref_ihe_pcd_tf_2_2024>> on how to populate the fields of the PID segment in this case.
====
****
...
Please refer also to the corresponding section in the <<ref_ihe_pcd_tf_2_2024>>.
