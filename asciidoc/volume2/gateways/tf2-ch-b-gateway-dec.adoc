...
The <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> represents the Device Observation Reporter (DOR) role of the IHE DEC profile.
...
.R8001
[sdpi_requirement#r8001,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
If available, the <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall export height and weight as OBX segments on the MDS level.
====
...
.R8002
[sdpi_requirement#r8002,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall use the *pm:PatientContextState/@BindingStartTime* as the timestamp for the height and weight observation and send new values as corrected results.
====
****
...
.R8003
[sdpi_requirement#r8003,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****

[NORMATIVE]
====
For the IHE DEC profile, the <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBR-2 field to the identifier of the Device Observation Reporter (DOR) of the IHE DEC gateway (not the individual device identifier).
====
...
.R8004
[sdpi_requirement#r8004,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****

[NORMATIVE]
====
For the IHE DEC profile, the <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBR-3 field to the identifier of the Device Observation Reporter (DOR) of the IHE DEC gateway (not the individual device identifier).
====
...
.R8005
[sdpi_requirement#r8005,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****

[NORMATIVE]
====
For the IHE DEC profile, the <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBR-4 field to the service identifier of the <<vol1_spec_sdpi_p_actor_somds_provider>>.
====
...
[cols="1"]
|===
a| *{standard_note}*:  In this version of the SDPi Standard, this section needs to be updated in order to be compliant with the <<ref_ihe_dev_tf_2_2024>>.
...
.R8037
[sdpi_requirement#r8037,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****

[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall export continuously (periodically) measured metrics periodically at a defined interval.
====

[NOTE]
====
It is up to the <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> how the export interval is defined. The interval might be a fixed interval of e.g., 30 seconds, or a configurable interval ranging e.g., between 10 seconds and 2 minutes.
====
****

.R8038
[sdpi_requirement#r8038,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****

[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBR-7 field to the start date and time of current export interval.
====

[NOTE]
====
If, for example, the export interval is set to 30 seconds, the <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> will export HL7 messages every 30 seconds with the OBR-7 field set to start date and time of the interval e.g., *20231030155930*, *20231030160000*, *20231030160030*, and so on.
====
****

.R8006
[sdpi_requirement#r8006,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****

[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall export the latest metric value of all continuously (periodically) measured metrics with a *pm:AbstractMetricState+++<wbr/>+++/pm:MetricValue+++<wbr/>+++/@DeterminationTime* which is equal or greater than the start date and time of the current interval, and less than the start date and time of the next export interval.
====
...
.R8007
[sdpi_requirement#r8007,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****

[NORMATIVE]
====
For exporting episodic metric values and the absence of any continuously measured metric values for the current export interval, a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBR-7 field to the start date and time of current export interval.
====
...
[NOTE]
Only metrics that fulfil certain criteria are exported by the <<vol1_spec_sdpi_r_actor_somds_dec_gateway>>. Please refer to <<r8018>> and <<r8017>> for further information.
...
.R8008
[sdpi_requirement#r8008,sdpi_req_level=may,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> may set the OBR-8 field to the end date and time of the current export interval.
====
...
* If, for example, the export interval is set to 30 seconds, the <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> will export HL7 messages every 30 seconds with the OBR-7 field set to start date and time of the current interval and the OBR-8 field set to the start date and time of the next interval e.g.,  *20231030155930*|*20231030160000*, *20231030160000*|*20231030160030*, and so on.
====
...
.R8009
[sdpi_requirement#r8009,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBR-10 field to the operator (user) information if available.
...
More information about the containment tree mapping can be found in *Appendix A Mapping IEEE 11073 Domain Information Model to HL7* in <<ref_ihe_dev_tf_2_2024>>.
...
.R8010
[sdpi_requirement#r8010,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBX-2 field to the metric value type code as defined in *HL7 table 0125*.
====
...
.R8011
[sdpi_requirement#r8011,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall leave the OBX-2 field empty for OBX segments defining the <<vol1_spec_sdpi_p_actor_somds_provider>>'s MDS, VMD, or CHAN containment tree elements.
====
****
...
.R8016
[sdpi_requirement#r8016,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBX-5 field to the value of the SDC metric.
====
...
.R8036
[sdpi_requirement#r8036,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
...
.R8017
[sdpi_requirement#r8017,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall only export metrics with a *pm:AbstractMetricValue/pm:MetricQuality/@Validity* set to *Vld* (Valid) or *Vldated* (Validated Data).
====
...
.R8018
[sdpi_requirement#r8018,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall only export metrics with the *pm:AbstractMetricDescriptor/@MetricCategory* set to *Msrmt* (Measurement), *Clc* (Calculation) or *Set* (Setting).
====
...
.R8019
[sdpi_requirement#r8019,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
For each numeric metric that complies with <<r8017>> and <<r8018>>, a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBX-5 field to the *pm:NumericMetricState/pm:MetricValue/@Value*.
====
...
* Note that sample array metrics are not supported by the <<vol1_spec_sdpi_r_actor_somds_dec_gateway>>.
====
****
...
====== String Metric
.R8020
[sdpi_requirement#r8020,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
For each string metric that complies with R8017 and R8018, a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBX-5 field to the *pm:StringMetricState/pm:MetricValue/@Value*.
====
****
...
.R8021
[sdpi_requirement#r8021,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
For each enumeration string metric that complies with R8017 and R8018, a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBX-5 field to a coded element value.
====
...
.R8022
[sdpi_requirement#r8022,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
If a private *<<acronym_mdc>>* code is used for the coding of the SDC coded element value in OBX-5 mapping, a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall map the identifier as described in Section <<ref_private_coding_system_note>>.
====
****
...
.R8023
[sdpi_requirement#r8023,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
For each numeric metric, a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBX-6 field to a measurement unit.
====
...
.R8024
[sdpi_requirement#r8024,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
If a private *<<acronym_mdc>>* code is used for the coding of the SDC measurement unit of a metric, a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall map the identifier as described in Section <<ref_private_coding_system_note>>.
====
****
...
.R8026
[sdpi_requirement#r8026,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall define the range of the alert limits on the metric level, if the *@Handle* of the metric is referenced by a *pm:LimitAlertConditionDescriptor* in the *pm:LimitAlertConditionDescriptor/pm:Source* list, by the format `<Lower Limit> - <Upper Limit>` where
...
.R8025
[sdpi_requirement#r8025,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall not set this field to the device measurement range capability for device related segments.
====

[NOTE]
====
As stated in <<ref_ihe_dev_tf_2_2024>> the reference range can only be set for device related segments (e.g., Channel). Within SDC the device measurement range refers to each metric and cannot be populated on higher levels in the containment tree.
====
****
...
.R8027
[sdpi_requirement#r8027,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall leave the OBX-8 field empty as specified in the <<ref_ihe_dev_tf_2_2024>> for valid and validated metric values.
====
****
...
.R8028
[sdpi_requirement#r8028,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
For a device-related element such as MDS, VMD, or CHANNEL, a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBX-11 field to *"X"*.
====
****

.R8029
[sdpi_requirement#r8029,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
For metrics with the *pm:AbstractMetricValue/pm:MetricQuality/@Validity* set to *Vld* (Valid), a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBX-11 field to *"R"*.
====
****

.R8030
[sdpi_requirement#r8030,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
For metrics with the *pm:AbstractMetricValue/pm:MetricQuality/@Validity* set to *Vldated* (Validated Data), a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBX-11 field to *"F"*.
====
****
...
.R8031
[sdpi_requirement#r8031,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBX-14 field to the date and time of the intermittently measured metric value.
====
...
.R8032
[sdpi_requirement#r8032,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
If available, a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBX-16 field to the operator.
====
...
* The <<ref_ihe_dev_tf_2_2024>> requires only the map the "ID Number", and optionally the "Family Name" and "Given Name" in this field, whereas the OBR-10 field may contain additional information about the operator.
====
****
...
.R8033
[sdpi_requirement#r8033,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBX-17 field to one of the coded terms as specified in <<ref_tbl_dec_obx17_mapping>>, depending on the *pm:AbstractMetricDescriptor/@MetricCategory* (Category) and the *pm:AbstractMetricDescriptor/@DerivationMethod* (Derivation).
====
****

.R8039
[sdpi_requirement#r8039,sdpi_req_level=should,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
A <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> should repeat the OBX-17 field to express the *pm:AbstractMetricDescriptor/@MetricAvailability* as specified in <<ref_tbl_dec_obx17_mapping2>>.
====
****
...
.R8034
[sdpi_requirement#r8034,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
If available for the metric, a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall set the OBX-20 field to body site.
====
...
.R8035
[sdpi_requirement#r8035,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
If a private *<<acronym_mdc>>* code is used for the coding of a body site, a <<vol1_spec_sdpi_r_actor_somds_dec_gateway>> shall map the identifier as described in Section <<ref_private_coding_system_note>>.
====
****
