...
====
NOTE: As stated in <<ref_ihe_pcd_tf_2_2024>> all observation times reported SHOULD be UTC, as indicated by including a time zone offset of +0000.
...
The following sections specify the general <<acronym_hl7>> V2 segment mappings. Please refer to the *Appendix B Common Segment Descriptions* of the <<ref_ihe_pcd_tf_2_2024>> for further information.
...
The following sections specify the general <<acronym_hl7>> V2 field mappings. Please refer to the *Appendix B Common Segment Descriptions* of the <<ref_ihe_pcd_tf_2_2024>> for further information.
