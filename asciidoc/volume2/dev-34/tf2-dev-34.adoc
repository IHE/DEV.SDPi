...
//[role=transaction,transaction-id=DEV-34]
=== _Reserved_ [{var_transaction_id}]
//DEV-34 deprecated because the former transaction was withdrawn with SDPi 2.2
DeprecateTransaction::DEV-34[version="2.2.0"]
...
[actor-id="somds_consumer",contribution=Receiver]
...
* <<ref_ieee_11073_10207_2017_Cor1_2025>> Section 9.2 Implicit Discovery
