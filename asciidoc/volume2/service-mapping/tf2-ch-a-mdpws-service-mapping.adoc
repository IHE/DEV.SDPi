...
|===
|Port Type (as <<term_q_name>>) |BICEPS service <<ref_ieee_11073_10207_2017_Cor1_2025>>
...
[NOTE]
====
* `GetContextStatesByIdentification` and `GetContextStatesByFilter` are insufficiently defined in <<ref_ieee_11073_10207_2017_Cor1_2025>> and are likely to be obsoleted in a future revision of the specification.
