...
This section specifies the MDPWS data transmission for messages defined in <<vol2_clause_dev_47>>, corresponding to the WS-Discovery managed mode bound to HTTP transmission.
