...
=== Retrieve Network Presence Metadata [{var_transaction_id}]
...
If a <<vol1_spec_sdpi_p_actor_somds_consumer>> uses a <<vol1_spec_sdpi_p_actor_somds_discovery_proxy>>, network presence is announced to the <<vol1_spec_sdpi_p_actor_somds_consumer>> by using the _{var_label_dev_47_message_hello}_ message of this transaction.
...
If a <<vol1_spec_sdpi_p_actor_somds_consumer>> uses a <<vol1_spec_sdpi_p_actor_somds_discovery_proxy>>, network absence is announced to the <<vol1_spec_sdpi_p_actor_somds_consumer>> by using the _{var_label_dev_47_message_bye}_ message of this transaction.
...
The {var_label_dev_47_message_probe} message is sent to a <<vol1_spec_sdpi_p_actor_somds_discovery_proxy>>
...
The {var_label_dev_47_message_resolve_match} message is sent whenever a <<vol1_spec_sdpi_p_actor_somds_discovery_proxy>> receives a <<vol2_clause_dev_47_message_resolve, {var_label_dev_47_message_resolve}>> message.
