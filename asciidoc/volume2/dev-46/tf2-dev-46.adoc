...
If a <<vol1_spec_sdpi_p_actor_somds_provider>> uses a <<vol1_spec_sdpi_p_actor_somds_discovery_proxy>>, network presence is announced to the <<vol1_spec_sdpi_p_actor_somds_discovery_proxy>> by using the _{var_label_dev_46_message_hello}_ message of this transaction.
...
If a <<vol1_spec_sdpi_p_actor_somds_provider>> uses a <<vol1_spec_sdpi_p_actor_somds_discovery_proxy>>, network absence is announced to the <<vol1_spec_sdpi_p_actor_somds_discovery_proxy>> by using the _{var_label_dev_46_message_bye}_ message of this transaction.
