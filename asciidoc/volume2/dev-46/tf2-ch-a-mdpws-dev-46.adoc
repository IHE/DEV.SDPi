...
This section specifies the MDPWS data transmission for messages defined in <<vol2_clause_dev_46>>, corresponding to the WS-Discovery managed mode bound to HTTP transmission.
...
.R7006
[sdpi_requirement#r7006,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
