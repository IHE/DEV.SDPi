...
[role=transaction,transaction-id=DEV-36]
...
[actor-id="somds_medical_data_consumer",contribution=Responder]
Listens for a Notification message to retrieve medical data updates.

[actor-id="somds_medical_data_provider",contribution=Initiator]
