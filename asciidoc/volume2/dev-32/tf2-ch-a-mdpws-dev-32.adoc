...
`s12:Envelope/s12:Body/wse:Subscribe/wse:Filter/hm:ReportFilter`:: An optional list of reports desired by the 
...
`s12:Envelope/s12:Body/wse:Subscribe/wse:Filter/hm:HandleFilter`:: An optional list of `pm:HandleRef`
...
`s12:Envelope/s12:Body/hm:ChangeSequenceReport/@Id`:: Globally unique identification of the request, preferably a UUID URN.
`s12:Envelope/s12:Body/hm:ChangeSequenceReport/@ReportNumber`:: Report counter starting at 0 to signify the first report of the request.
