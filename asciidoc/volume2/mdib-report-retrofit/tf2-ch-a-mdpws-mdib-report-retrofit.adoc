...
[NORMATIVE]
====
A <<vol1_spec_sdpi_p_actor_somds_provider>> shall not send a notification of a subscription as long as there is another notification pending for that subscription.
====

[NOTE]
====
This also requires <<vol1_spec_sdpi_p_actor_somds_provider>>s to serialize delivery of msg:OperationInvokedReport messages.
====
****
