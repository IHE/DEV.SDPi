...
* A <<vol1_spec_sdpi_p_actor_somds_consumer>> may receive multiple message notifications with the same `sdpi:ReportSequence/@MessageNumber` when it responds with a fault code 
====
****
