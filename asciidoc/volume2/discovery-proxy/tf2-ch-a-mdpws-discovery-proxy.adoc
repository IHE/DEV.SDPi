...
[NOTE]
====
* The <<vol1_spec_sdpi_p_actor_discovery_proxy>> port type is defined in <<vol2_clause_appendix_a_mdpws_discovery_proxy_wsdl>>.
...
<<vol2_clause_appendix_a_mdpws_discovery_proxy_wsdl>> shows the WSDL file that specifies the <<vol1_spec_sdpi_p_actor_discovery_proxy>> Web Service interface.

.Discovery Proxy WSDL outline
[source#vol2_clause_appendix_a_mdpws_discovery_proxy_wsdl,xml]
----
