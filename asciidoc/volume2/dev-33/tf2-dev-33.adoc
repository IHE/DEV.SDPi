...
[[payload_dev_33_getlocalizedtextresponse_text]]Text:: The sequence of available languages the <<vol1_spec_sdpi_p_actor_somds_provider>> is able to translate to, based on <<r0504>>.
