...
[#clause_p_n_t_interperability_requirements_management,sdpi_offset=clear]
= Plug-and-Trust Interoperability Requirements Management

This standard includes a model-centric integration of requirements from multiple sources -- both within Gemini and from other <<acronym_sdo>>s -- enabling a new level of *requirements management* that provides new value to all stakeholders.  Also termed *_<<term_requirements_interoperability>>_*, innovative capabilities include:
...
The following sections provide background on the concepts and rationale behind requirements interoperability and the details for how it is implemented in this specification.


[#clause_requirements_from_narratives_to_pnt_interfaces,sdpi_offset=1]
...
image::../images/diagram-hanging-gardens.svg[]
...
. Requirement TYPEs are rooted in the layers that they represent and link type definitions to their use in this specification; see <<clause_sdpi_requirements_core_model>> Section below.

NOTE:  The implementation of this high-level framework will be extended as the specifications and tooling mature.


[#clause_integrating_ses]
...
[#clause_ses_considerations_section_template]
== SES Considerations Section Template

Given the forgoing discussion in <<clause_ses_considerations_requirements>>, a standardized template is defined for addressing <<acronym_ses>> requirements as appropriate, including within the scope of profiles, actors, transactions, and content modules.
...
[#clause_ses_considerations_and_requirements]
...
[#clause_sdpi_requirements_modeling_integration]
...
[#clause_sdpi_requirements_core_model]
...
| See <<clause_use_case_specification_conventions_using_cucumber_gherkin>>
...
| See SES Section <<clause_integrating_ses>>
...
[#clause_sdpi_requirement_type_requirement_definition]
...
| See <<clause_sdpi_requirement_assigning_unique_identifiers>> and https://github.com/IHE/DEV.SDPi/blob/master/articles/sdpi-article-ihe-tf-asciidoc-cookbook.adoc#semantic-requirements[defining requirements] for additional discussion; note this identifier may be used for tracking in systems such as requirement management tools
...
[#clause_sdpi_requirement_assigning_unique_identifiers]
...
[#clause_sdpi_requirement_type_technical_feature]
...
[#clause_sdpi_requirement_type_ihe_profile]
...
This reflects the ultimate objective of having a fully modeled specification, with the documentation generated automatically (see <<clause_sdpi_requirement_future_extensibility>>).
...
[#clause_sdpi_requirement_type_use_case_feature]
...
[#clause_sdpi_requirement_type_referenced_standard_ics]
...
[#clause_sdpi_requirement_type_ses]
...
[#clause_sdpi_requirement_use_type_requirement_fulfillment]
...
[#clause_sdpi_requirement_future_extensibility]
