...
////
TODO: for some reason, include macros in this file are (partially?) executed such that block processing plugins
      fail due to missing input data. To avoid that, the include directions in this file has been changed from
      "include::" to "include:".
////
