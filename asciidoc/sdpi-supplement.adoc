...
:sdpi_milestone_publication: SDPi 2.4 Publication
:sdpi_milestone_review: SDPi 2.4 Review
...
[cols="1"]
|===
a| *SDPi "Standalone" Supplement -- Drafting Note*:
...
. Add top level outline structure for supplement document
. Change all labels to be supplement-specific & not duplicated from sdpi-standard
...
//
include::supplement/sdpi-supplement-document-declarations.adoc[]

// STANDALONE SDPi:  1st refactoring, moved copies of these files into the supplement/ directory
...
// Standalone TO DO - Do we move all these files in volume0 directory under supplement/ ?  It won't be relevant for the STANDALONE SDPi
...
// Standalone TO DO - Add in sections below
...
|===
| *{supplement_note}*:
IHE Supplement TF-1:B References Appendix content is provided in *Gemini Standard TF-1:B*.
|===
...
|===
| *{supplement_note}*:
IHE Supplement TF-1:B.1 Referenced Standards  content is provided in *Gemini Standard TF-1:B.1 Referenced Standards*.
|===
