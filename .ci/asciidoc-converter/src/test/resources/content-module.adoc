...
[role=actor,actor-id=content-consumer,reftext="Content consumer",oid-arcs=.99]
==== Content consumer
...
[role=actor,actor-id=content-creator,reftext="Content creator",oid-arcs=.98]
==== Content creator
...
[role="content-module",content-module-id=biceps,reftext="Biceps content module",oid-arcs=.98]
== Biceps content module

Cras vestibulum volutpat tortor sit amet hendrerit. Sed efficitur tempus molestie. 

[role="content-module",content-module-id=pump,reftext="Pump content module",oid-arcs=.97]
== Pump content module
